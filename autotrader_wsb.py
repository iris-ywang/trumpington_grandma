...
class AutoTrader(BaseAutoTrader):
    ...
    def __init__(self, loop: asyncio.AbstractEventLoop, team_name: str, secret: str):
        ...
        # self.future_ask_best = 0
        # self.future_bid_best = 0
        self.etf_ask_best = 0
        self.etf_bid_best = 0
        self.etf_ask_vol = 0
        self.etf_bid_vol = 0
    ...
    def on_order_book_update_message(self, instrument: int, sequence_number: int, ask_prices: List[int],
        ...
        if instrument == Instrument.FUTURE:
            ...
            self.etf_bid_best = bid_prices[0]
            self.etf_bid_vol = bid_volumes[0]
            self.etf_ask_best = ask_prices[0]
            self.etf_ask_vol = ask_volumes[0]
